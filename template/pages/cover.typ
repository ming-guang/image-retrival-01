...
#let cover_page(
  ...
  place(
    ...
    dx: -13mm,
    dy: 10mm,
    image("../../assets/images/logo.png", width: 164pt),
  )
    ...
    box(
      align(
        ...
        stack(
          ...
          v(3mm),
          text("Ho Chi Minh University of Science", size: 9pt, weight: "bold"),
          v(2mm),
          text("Faculty of Information Technology", size: 9pt, weight: "bold"),
        ),
      ),
    ),
  )
